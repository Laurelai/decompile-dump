char GetProcAddress[0] = "\xffffffa44";
...
int global22 = 0;
int global21 = 0;
char lstrlenW[0] = "\xffffff984";
char GetModuleHandleW[0] = "f5";
char wsprintfW[0] = "(5";
char GetCurrentThreadId[0] = "z5";
char GetTickCount[0] = "\x1c4";
char lstrcpyW[0] = "\xfffffffe4";
int global24 = 1;
...
proc1(int param2, int param1, int param5, int param3, int param4) {
    ...
    if (param1 == 0) {
        GetTickCount();
        GetCurrentThreadId();
        param5 = proc9(0x1000306c, local19 - 92, param3, param4, local19 - 92); /* Warning: also results in param3 */
        do {
            wsprintfW();
...
L17:
        ...
        global8 = local43;
        local40 = 0x1000309c;
        local43 = proc7(0x1000309c, param1, param2, param3); /* Warning: also results in param1, param3 */
        global9 = local43;
        local38 = 0x100030b0;
        local43 = proc7(0x1000309c, param1, param2, param3); /* Warning: also results in param1, param3 */
        global10 = local43;
        ...
        global16 = local43;
        local24 = 0x10003190;
        local43 = proc7(0x1000309c, param1, param2, param3); /* Warning: also results in param1, param3, local45 */
        global17 = local43;
        local22 = 0x100031a8;
        local43 = proc8(0x1000309c, param1, param2, param3); /* Warning: also results in param1, param3, local45 */
        global18 = local43;
        local20 = 0x100031c8;
        local43 = proc8(0x1000309c, param1, param2, param3); /* Warning: also results in param1, param3 */
        global19 = local43;
        local18 = 0x100031f0;
        local43 = proc7(0x1000309c, param1, param2, param3); /* Warning: also results in param1, param3 */
        global20 = local43;
        ...
        global22 = local43;
        local12 = 0x10003258;
        local43 = proc8(0x1000309c, param1, param2, param3); /* Warning: also results in param4, param1, param3, local45 */
        local44 = local0;
        global23 = local43;
        local43 = 1;
    } else {
...
proc4(int param2, int param1, int param3) {
    ...
    if (local43 == 0) {
        ...
        local62 = proc16();
        local68 = local62;
        local41 = *(int*)(local2 - 24) + 16;
        local67 = local41;
        local66 = local2 - 28;
        local65 = *(int*)(local2 - 16);
        local64 = local2 - 24;
        proc11(local2 - 24, local2 - 28, local41, local62, *(int*)(local2 - 8), *(int*)(local2 - 16));
        local110 = *(int*)(local2 - 24) + 36;
        local60 = local110 + 34;
        local40 = *(int*)(*(int*)(local2 - 24) + 8) + 206;
        local59 = local40;
        local56 = proc17();
        local39 = local56 + *(int*)(*(int*)(local2 - 24) + 16);
        local55 = local39;
        local42 = proc18();
        local38 = local42 + *(int*)(*(int*)(local2 - 24) + 16);
        local52 = local38;
        local51 = *(int*)(local2 + 12);
        local50 = *(int*)(*(int*)(local2 - 24) + 16);
        local49 = *(int*)(local2 - 16);
        local48 = *(int*)(local2 - 24);
        (*global14)(pc - 90, param2, local44 + 1266, local113 - 44, local113 - 28, local113 - 20, 1189, 41, 0, 0, local44 + 1266, 0, local44, pc - 0xe89, param1, local2 - 24, local2 - 28, local41, *(int*)(local2 - 24), *(int*)(local2 + 20), *(int*)(local2 - 16), local112, local2, local40, local38, *(int*)(local2 + 12), local43, *(int*)(local2 - 24), local45, 36, local110 + 34, 36, *(int*)(local2 - 16), *(int*)(*(int*)(local2 - 24) + 16), *(int*)(local2 - 16), local39, ADDFLAGS32(local42, *(int*)(*(int*)(local2 - 24) + 16), local38), ADDFLAGS32(local42, *(int*)(*(int*)(local2 - 24) + 16), local38));
...
proc6(int param1, int param2) {
    ...
    param1 = proc9(0x100032d0, local9 - 204, param1, param2, local9 - 204);
...
proc7(int param1, int param2, int param3, int param4) {
    ...
    local4 = proc19(0x100032b4, param1, param2, param3, param4); /* Warning: also results in param2, param4, edx */
    return local4; /* WARNING: Also returning: param2, param4, edx */
}
...
proc8(int param1, int param2, int param3, int param4) {
    ...
    local4 = proc19(0x100032d0, param1, param2, param3, param4); /* Warning: also results in local3, param2, param4, edx */
    return local4; /* WARNING: Also returning: local3, param2, param4, edx */
}
...
proc10(int param2, int param3, int param1) {
    ...
    if (local41 == 0) {
        ...
        local69 = *(int*)0x1000305c;
        (*local68)(local53, local52, local65, local51, *(int*)0x1000305c, local64, local50, *(int*)*(int*)(local3 + 16), local63, local49, local99, local62, local48, *(int*)(local3 + 20), local61, local47, 0, local60, local46, 0, local59, local45, 0, local58, local3 - 16, local57, local44, 1, local56, local43, 0, local42, local54, local55, *(int*)(local3 + 16), local100, local101, local3, local66, local67, local41, <all>, LOGICALFLAGS32(0), LOGICALFLAGS32(0));
        local98 = local2;
        local40 = local99;
        if (local99 == 0) {
            local39 = 64;
