char _initterm[0] = "\x06m\x01";
void global17;
char GetSystemTimeAsFileTime[0] = "\xffffff8cn\x01";
int global1 = 0x44bf19b1;
int global0 = 0xbb40e64e;
char QueryPerformanceCounter[0] = "6n\x01";
char GetTickCount[0] = "Pn\x01";
char GetCurrentThreadId[0] = "`n\x01";
char GetCurrentProcessId[0] = "vn\x01";
char _amsg_exit[0] = "\x12m\x01";
int global7 = -1;
int global16;
int global15;
int global14;
char InterlockedCompareExchange[0] = "\xffffffb6m\x01";
int global12;
char _adjust_fdiv[0] = " m\x01";
int global10;
...
void _start(int param6, int param4, int param2, int param1, int param7, int param5, int param3);
proc5();
...
void _start(int param6, int param4, int param2, int param1, int param7, int param5, int param3) {
    ...
    local204 = param1;
    if (param6 == 1) {
        param7 = proc1(param7); /* Warning: also results in param5 */
        local275 = local206;
    }
    local191 = local275;
    local197 = 44;
    local198 = 0x10016a10;
    local199 = local191;
    local203 = local191 + 1409;
    local3 = proc2(0x10016a10, param1, param2, param7, param5); /* Warning: also results in local190 */
    local208 = local3;
    local209 = local190;
    local211 = local203;
    local212 = local197;
...
L29:
            if (global17 != 0) {
                ...
                local192 = local191 + 1409;
                (*global17)(local191 + 1409, *(int*)(local190 + 8), local191, *(int*)(local190 + 12), 0x10016a10, *(int*)(local190 + 16), param1, global17, *(int*)(local190 + 12), 1, local190, 0, param5, 1, 1, SUBFLAGS32(global17, 0, global17), (unsigned)global17 < 0);
                local208 = local176;
                local209 = local6;
                local210 = local188;
                local211 = local189;
            ...
            local273 = local149;
            local274 = local167;
            if (*(int*)(local166 - 28) != param7) {
                *(int*)(local166 - 4) = 2;
                *(int*)(local165 - 4) = *(int*)(local166 + 16);
                local168 = *(int*)(local166 + 12);
                *(int*)(local165 - 12) = *(int*)(local166 + 8);
                *(int*)(local165 - 16) = local167;
                local150 = local167 - 559;
                local276 = proc6(*(int*)(local165 - 8), param4, local277, local278, param2, local166, param7, param5, param3, global14[0], global15[0], global16[0]); /* Warning: also results in param7, param4, local278, param2, local135, local5, param5 */
                local223 = local135;
                local224 = local5;
                local226 = local150;
                local271 = local135;
                    ...
                    if (*(int*)(local12 + 12) == 1) {
                        if (local276 == local13) {
                            ...
                            *(int*)(local120 - 4) = local13;
                            local121 = local13;
                            *(int*)(local120 - 12) = *(int*)(local12 + 8);
                            *(int*)(local120 - 16) = local31 + 0x910;
                            local118 = local31 + 1575;
                            param7 = proc6(*(int*)(local120 - 8), param4, local2, local278, param2, local12, local13, param5, param3, global14[0], global15[0], global16[0]); /* Warning: also results in param4, local277, local278, param2, local4, local9, param5 */
                            local240 = local277;
                            local241 = local4;
                            local242 = local9;
                            local243 = param7;
                            ...
                            if (local94 != param7) {
                                ...
                                local95 = local31 + 1575;
                                (*local94)(*(int*)(local33 - 16), local31 + 1575, local86, local31 + 0x910, *(int*)(local33 - 12), *(int*)(local9 + 8), local85, local82, *(int*)(local12 + 8), *(int*)(local33 - 8), param7, local84, local81, local13, local13, *(int*)(local33 - 4), param7, local83, param1, param4, local94, local277, local278, param2, local9, param7, param5, local87, local88, local89, local90, 0, 1, *(int*)(local7 - 4), *(int*)(local8 - 4), *(int*)(local8 - 28), 6, *(int*)(local10 - 4), *(int*)(local10 - 28), 5, local276, param3, SUBFLAGS32(local94, param7, local94 - param7), (unsigned)local94 < (unsigned)param7);
                                local240 = local277;
                                local241 = local53;
                                local242 = local7;
                                local243 = param7;
...
L9:
                        ...
                        *(int*)(local49 - 16) = local30;
                        local48 = local30 - 860;
                        local1 = proc6(*(int*)(local49 - 8), param4, local277, local278, param2, local11, param7, param5, param3, global14[0], global15[0], global16[0]); /* Warning: also results in param7, param4, local277, local278, param2, local33, local10, param5 */
                        local271 = local33;
                        local271 = local33;
                        local272 = local10;
                        local272 = local10;
                        ...
                        local45 = param7;
                        if (local1 != param7) {
                            if (*(int*)0x10018548 != param7) {
                                local37 = 8;
                                local36 = *(int*)(local10 + 16);
                                local35 = *(int*)(local10 + 12);
                                local34 = *(int*)(local10 + 8);
                                local32 = local30 - 860;
                                (**(int*)0x10018548)(local30 - 860, local23, local19, local30, local31, *(int*)(local10 + 8), local22, local18, local15, *(int*)(local11 + 8), *(int*)(local12 + 8), *(int*)(local10 + 12), local21, local17, local14, *(int*)(local11 + 12), local2, *(int*)(local10 + 16), local20, local16, param1, *(int*)(local11 + 16), *(int*)(local12 + 16), param4, *(int*)0x10018548, local277, local278, param2, local10, param7, param5, local24, local25, local26, local27, 0, 1, local28, *(int*)(local8 - 4), *(int*)(local8 - 28), local29, 8, local1, 7, local13, local276, param3, SUBFLAGS32(*(int*)0x10018548, param7, *(int*)0x10018548 - param7), (unsigned)*(int*)0x10018548 < (unsigned)param7);
                                local271 = local279;
                                local272 = local8;
                                local273 = global7;
    ...
    *(int*)(param1 - 4) = -2;
    proc3();
    proc4(*(int*)(local279 + 4), param6, *(int*)(local279 + 12), param1, *(int*)(param1 - 16), *(int*)param1);
    return;
}
...
L42:
        ...
        if (param3 != 1) {
            ...
            if (param3 == 0) {
                ...
                if (*(int*)0x10018538 == 2) {
                    param4 = *(int*)0x10018544;
                    if (*(int*)0x10018544 != 0) {
                        param1 = *(int*)0x10018540 - 4;
                        local6 = local335;
                        local10 = local336;
                        local34 = local337;
                        local35 = local338;
                        ...
                        while ((unsigned)param1 >= (unsigned)param4) {
                            if (*(int*)param1 != 0) {
                                *(int*)(local6 - 4) = local30;
                                (**(int*)param1)(local18, local17, *(int*)(local9 - 12), *(int*)(local7 - 12), *(int*)(local5 - 12), local16, local21, local27, *(int*)(local9 - 8), *(int*)(local8 - 8), *(int*)(local7 - 8), *(int*)(local6 - 8), *(int*)(local5 - 8), local15, local20, local24, local26, *(int*)(local9 - 4), *(int*)(local8 - 4), *(int*)(local7 - 4), local30, *(int*)(local5 - 4), local14, local19, local22, local23, local25, local12, local11, param6, *(int*)param1, param13, param7, param4, local10, param5, param1, local13, local28, local29, *(int*)local8, param11, global14[0], global15[0], global16[0], LOGICALFLAGS32(*(int*)param1), LOGICALFLAGS32(*(int*)param1));
                                local310 = local225;
                                local311 = local226;
                                local312 = local247;
                                local313 = global12;
...
L34:
            ...
            if (*(int*)0x10018538 == 0) {
                ...
                local133 = 1;
                local127 = local189;
                local379 = proc8(0x100160f0, local39, param5, 2, param11); /* Warning: also results in param5, local2, param2, param1 */
                local274 = param2;
                local278 = local125;
                local279 = local126;
                local280 = local127;
                    ...
                    if (*(int*)0x1001854c != 0) {
                        *(int*)local8 = 0x1001854c;
                        ...
                        if (local379 != 0) {
                            ...
                            (**(int*)0x1001854c)(local99, local98, *(int*)(local9 - 12), *(int*)(local7 - 12), *(int*)(local5 - 12), local97, param12 + 1404, local103, *(int*)(local9 - 8), *(int*)(local8 - 8), *(int*)(local7 - 8), *(int*)(local6 - 8), *(int*)(local5 - 8), local96, *(int*)(param2 + 8), local102, *(int*)(local9 - 4), param12, *(int*)(local7 - 4), *(int*)(local6 - 4), *(int*)(local5 - 4), local95, param1, local100, local101, 2, local93, local190, param6, local379, local104, param7, param4, param2, param5, param1, local94, *(int*)(param2 + 16), local105, 0x1001854c, param11, global14[0], global15[0], global16[0], LOGICALFLAGS32(local379), LOGICALFLAGS32(local379));
                            local282 = local380;
                            local283 = local192;
                            local284 = global12;
                            local285 = global14;
...
proc9(int param4, int param1, int param2, int param3) {
    ...
    *(int*)(local7 - 4) = 8;
    *(int*)(local7 - 8) = 0x10016a90;
    ebp = proc2(0x10016a90, 8, param1, param2, param3);
    *(int*)(ebp - 4) = 0;
    local6 = 0x10000000;
