...
extern _UNKNOWN unk_10003068; // weak
extern _UNKNOWN unk_10003098; // weak
extern _UNKNOWN unk_100030AC; // weak
extern _UNKNOWN unk_100030C8; // weak
extern _UNKNOWN unk_100030E8; // weak
extern _UNKNOWN unk_10003108; // weak
extern _UNKNOWN unk_10003124; // weak
extern _UNKNOWN unk_10003144; // weak
extern _UNKNOWN unk_10003170; // weak
extern _UNKNOWN unk_1000318C; // weak
extern _UNKNOWN unk_100031A4; // weak
extern _UNKNOWN unk_100031C4; // weak
extern _UNKNOWN unk_100031EC; // weak
extern _UNKNOWN unk_10003208; // weak
extern _UNKNOWN unk_10003230; // weak
extern _UNKNOWN unk_10003254; // weak
extern _UNKNOWN unk_100032B0; // weak
extern _UNKNOWN unk_100032CC; // weak
...
int __cdecl sub_100010AD(int, LPCWSTR lpFileName); // idb
// int __usercall sub_10001128<eax>(int a1<ecx>, unsigned int a2<edi>);
bool __cdecl sub_10001186();
// signed int __usercall sub_100011CE<eax>(const WCHAR *a1<eax>, WCHAR *a2);
int __cdecl sub_1000123A(HMODULE hModule); // idb
// signed int __usercall sub_100012B2<eax>(unsigned int a1<esi>);
bool __cdecl sub_100012F3(LPCWSTR lpFileName, int a2);
int __cdecl 2(LPCWSTR lpString2); // idb
// signed int __usercall sub_100013EB<eax>(DWORD *a1<edi>, LPCWSTR lpFileName, LPVOID *a3);
...
BOOL __stdcall DllEntryPoint(HINSTANCE hinstDLL, DWORD fdwReason, LPVOID lpReserved)
{
  ...
  if ( fdwReason && fdwReason == 1 && (DisableThreadLibraryCalls(hinstDLL), sub_10001186()) )
...
int __stdcall StartAddress(LPCWSTR lpString2)
{
  ...
  if ( lpString2 )
  {
    v1 = lstrlenW(lpString2) + 1;
    if ( v1 > 260 )
      v1 = 260;
    lstrcpynW(&FileName, lpString2, v1);
...
signed int __cdecl sub_100010AD(int a1, LPCWSTR lpFileName)
{
  ...
  lpAddress = 0;
  v3 = 0;
  result = sub_100013EB((DWORD *)&v7, lpFileName, &lpAddress);
  if ( result )
  {
    v4 = v7;
    sub_10001128((int)lpAddress, v7);
    if ( !sub_10001BA9(0, v5, v4, (int)&hLibModule) )
    {
      v6 = GetProcAddress(hLibModule, (LPCSTR)0x1F);
      if ( v6 )
        v3 = ((int (__cdecl *)(int, signed int))v6)(a1, 1);
...
signed int __usercall sub_100011CE<eax>(const WCHAR *a1<eax>, WCHAR *a2)
{
  ...
  if ( v4 <= (unsigned int)v3
    || (v6 = (WCHAR *)(v4 + 4),
        ...
        v7 + lstrlenW(L"XUTILS\\listen\\XR000000.MDX") >= 260) )
  {
LABEL_12:
    result = 0;
  }
  ...
  {
    lstrcpyW(v6, L"XUTILS\\listen\\XR000000.MDX");
    result = 1;
  }
  return result;
}
...
//----- (1000123A) --------------------------------------------------------
int __cdecl sub_1000123A(HMODULE hModule)
{
  FARPROC v2; // eax@6
  ...
  if ( !GetModuleFileNameW(hModule, &FileName, 0x104u) )
    return 0;
  if ( sub_100012B2((unsigned int)&FileName) )
    return 1;
  if ( !sub_100012F3(&FileName, (int)&hLibModule) )
    return 0;
...
// 10003318: using guessed type wchar_t aShell32_dll_as[18];
...
bool __cdecl sub_100012F3(LPCWSTR lpFileName, int a2)
{
  ...
  v3 = sub_100013EB((DWORD *)&v9, lpFileName, &lpAddress);
  SetErrorMode(v2);
  if ( v3 )
  {
    v6 = GetTickCount() / 7;
...
signed int __thiscall sub_100014AB(DWORD this)
{
    ...
    || VirtualProtect(&dword_1000215A, 0x44u, 0x40u, &flOldProtect) )
  {
    ...
    dword_10002162 = (int)sub_1000227E((int)&unk_10003098);
    dword_10002166 = (int)sub_1000227E((int)&unk_100030AC);
    dword_1000216A = (int)sub_1000227E((int)&unk_100030C8);
    dword_1000216E = (int)sub_1000227E((int)&unk_100030E8);
    dword_10002172 = (int)sub_1000227E((int)&unk_10003108);
    dword_10002176 = (int (__stdcall *)(_DWORD))sub_1000227E((int)&unk_10003124);
    dword_1000217A = (int)sub_1000227E((int)&unk_10003144);
    dword_1000217E = (int)sub_1000227E((int)&unk_10003170);
    dword_10002182 = (int)sub_1000227E((int)&unk_1000318C);
    dword_10002186 = (int (__stdcall *)(_DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD))sub_1000228F((int)&unk_100031A4);
    dword_1000218A = (int (__stdcall *)(_DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD))sub_1000228F((int)&unk_100031C4);
    dword_1000218E = (int)sub_1000227E((int)&unk_100031EC);
    dword_10002192 = (int)sub_1000227E((int)&unk_10003208);
    dword_10002196 = (int)sub_1000227E((int)&unk_10003230);
    dword_1000219A = (int (__stdcall *)(_DWORD))sub_1000228F((int)&unk_10003254);
    result = 1;
  }
  else
  {
...
signed int __cdecl sub_100016E4(int a1, LPCWSTR lpString2)
{
  ...
  else
  {
    ...
    sub_100021C1((int)&unk_10003068, (int)&v4);
    do
...
HMODULE __cdecl sub_100021FE()
{
  ...
  sub_100021C1((int)&unk_100032CC, (int)&ModuleName);
...
FARPROC __cdecl sub_1000227E(int a1)
{
  return sub_10002229((int)&unk_100032B0, a1);
}

//----- (1000228F) --------------------------------------------------------
FARPROC __cdecl sub_1000228F(int a1)
{
  return sub_10002229((int)&unk_100032CC, a1);
}
