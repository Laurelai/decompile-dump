...
extern int dword_10001F1A; // weak
extern int dword_10001F22; // weak
extern int dword_10001F26; // weak
extern int dword_10001F2A; // weak
extern int dword_10001F2E; // weak
extern int dword_10001F32; // weak
extern int (__stdcall *dword_10001F36)(_DWORD); // weak
extern int dword_10001F3A; // weak
extern int dword_10001F3E; // weak
extern int dword_10001F42; // weak
extern int (__stdcall *dword_10001F46)(_DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD); // weak
extern int (__stdcall *dword_10001F4A)(_DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD); // weak
extern int dword_10001F4E; // weak
extern int dword_10001F52; // weak
extern int dword_10001F56; // weak
extern int (__stdcall *dword_10001F5A)(_DWORD); // weak
extern _UNKNOWN unk_10003040; // weak
extern _UNKNOWN unk_10003070; // weak
extern _UNKNOWN unk_10003084; // weak
extern _UNKNOWN unk_100030A0; // weak
extern _UNKNOWN unk_100030C0; // weak
extern _UNKNOWN unk_100030E0; // weak
extern _UNKNOWN unk_100030FC; // weak
extern _UNKNOWN unk_1000311C; // weak
extern _UNKNOWN unk_10003148; // weak
extern _UNKNOWN unk_10003164; // weak
extern _UNKNOWN unk_1000317C; // weak
extern _UNKNOWN unk_1000319C; // weak
extern _UNKNOWN unk_100031C4; // weak
extern _UNKNOWN unk_100031E0; // weak
extern _UNKNOWN unk_10003208; // weak
extern _UNKNOWN unk_1000322C; // weak
extern _UNKNOWN unk_10003288; // weak
extern _UNKNOWN unk_100032A4; // weak
...
int __stdcall DllUnregisterServerEx(int a1, int a2, int a3);
...
// int __usercall sub_10001103<eax>(int a1<ecx>, unsigned int a2<edi>);
signed int __cdecl sub_10001161(int a1, int a2);
BOOL __cdecl sub_100011EE();
signed int __thiscall sub_1000126B(DWORD this);
signed int __cdecl sub_100013A6(int a1, int a2, int a3, int a4, int a5);
...
void __cdecl sub_10001DF1();
// int __usercall sub_10001E44<eax>(int a1<eax>, int a2<edx>, int a3<ecx>);
int __cdecl sub_10001F5E(int a1, int a2);
__int16 __cdecl sub_10001F81(int a1, int a2);
HMODULE __cdecl sub_10001FBE();
FARPROC __cdecl sub_10001FE9(int a1, int a2);
void __cdecl sub_1000202A(void *a1, const void *a2, unsigned int a3);
FARPROC __cdecl sub_1000203E(int a1);
FARPROC __cdecl sub_1000204F(int a1);
...
void __cdecl sub_10002493(void *a1, const void *a2, unsigned int a3);
...
signed int __cdecl sub_1000109B()
{
  ...
  {
    v1 = v4;
    sub_10001103(v4 + *(_DWORD *)v4, *(_DWORD *)(v4 + 4));
...
signed int __thiscall sub_1000126B(DWORD this)
{
  ...
  flOldProtect = this;
  if ( VirtualProtect(&dword_10001F1A, 0x44u, 0x80u, &flOldProtect)
    || VirtualProtect(&dword_10001F1A, 0x44u, 0x40u, &flOldProtect) )
  {
    dword_10001F1A = (int)sub_10001FBE();
    dword_10001F22 = (int)sub_1000203E((int)&unk_10003070);
    dword_10001F26 = (int)sub_1000203E((int)&unk_10003084);
    dword_10001F2A = (int)sub_1000203E((int)&unk_100030A0);
    dword_10001F2E = (int)sub_1000203E((int)&unk_100030C0);
    dword_10001F32 = (int)sub_1000203E((int)&unk_100030E0);
    dword_10001F36 = (int (__stdcall *)(_DWORD))sub_1000203E((int)&unk_100030FC);
    dword_10001F3A = (int)sub_1000203E((int)&unk_1000311C);
    dword_10001F3E = (int)sub_1000203E((int)&unk_10003148);
    dword_10001F42 = (int)sub_1000203E((int)&unk_10003164);
    dword_10001F46 = (int (__stdcall *)(_DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD))sub_1000204F((int)&unk_1000317C);
    dword_10001F4A = (int (__stdcall *)(_DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD))sub_1000204F((int)&unk_1000319C);
    dword_10001F4E = (int)sub_1000203E((int)&unk_100031C4);
    dword_10001F52 = (int)sub_1000203E((int)&unk_100031E0);
    dword_10001F56 = (int)sub_1000203E((int)&unk_10003208);
    dword_10001F5A = (int (__stdcall *)(_DWORD))sub_1000204F((int)&unk_1000322C);
    result = 1;
  }
  else
  {
...
// 10001F22: using guessed type int dword_10001F22;
// 10001F26: using guessed type int dword_10001F26;
// 10001F2A: using guessed type int dword_10001F2A;
// 10001F2E: using guessed type int dword_10001F2E;
// 10001F32: using guessed type int dword_10001F32;
// 10001F36: using guessed type int (__stdcall *dword_10001F36)(_DWORD);
// 10001F3A: using guessed type int dword_10001F3A;
// 10001F3E: using guessed type int dword_10001F3E;
// 10001F42: using guessed type int dword_10001F42;
// 10001F46: using guessed type int (__stdcall *dword_10001F46)(_DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD);
// 10001F4A: using guessed type int (__stdcall *dword_10001F4A)(_DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD);
// 10001F4E: using guessed type int dword_10001F4E;
// 10001F52: using guessed type int dword_10001F52;
// 10001F56: using guessed type int dword_10001F56;
...
signed int __cdecl sub_100013A6(int a1, int a2, int a3, int a4, int a5)
{
  ...
  v9 = a2;
  v10 = 0;
  if ( dword_10001F46(a3, 983071, 0, &v9, 64, 134217728, 0) )
  {
    result = -5;
  }
  else
  {
    ...
    v8 = dword_10001F4A(*(_DWORD *)a3, v6, a4, 0, 0, 0, &v7, 1, 0, 64);
    if ( v8 )
    {
      result = -5;
    }
    ...
    {
      v8 = dword_10001F4A(*(_DWORD *)a3, a1, a5, 0, 0, 0, &v7, 1, 0, 64);
      if ( v8 )
        result = -5;
      else
        result = 0;
...
signed int __cdecl sub_100014A4(int a1, LPCWSTR lpString2)
{
  ...
  else
  {
    ...
    sub_10001F81((int)&unk_10003040, (int)&v4);
    do
...
int __cdecl sub_10001559(int a1, const void *a2, const void *a3, unsigned int a4, int a5, const void *a6, unsigned int a7, int a8)
{
  ...
  v12 = 0;
  v15 = a4 + a7 + 152;
  v18 = sub_100013A6(a1, a4 + a7 + 152, (int)&v9, (int)&v13, (int)&v16);
  if ( v18 )
  {
    result = v18;
  }
  else
  {
    ...
    sub_1000202A((void *)v17, a2, 0x80u);
    *(_DWORD *)(v17 + 148) = a5;
    *(_DWORD *)(v17 + 128) = 0;
    *(_DWORD *)a8 = v16;
    dword_10001F36(v17);
...
// 10001F36: invalid function type has been ignored
// 10001F5A: invalid function type has been ignored
// 10001F36: using guessed type int (__stdcall *dword_10001F36)(_DWORD);
// 10001F5A: using guessed type int (__stdcall *dword_10001F5A)(_DWORD);
...
int __cdecl sub_10001969(LPCWSTR lpString2, const void *a2, unsigned int a3, int a4)
{
  ...
  if ( !result )
  {
    if ( dword_10004000 && !sub_1000126B(v8) )
      return -12;
...
HMODULE __cdecl sub_10001FBE()
{
  ...
  sub_10001F81((int)&unk_100032A4, (int)&ModuleName);
...
FARPROC __cdecl sub_10001FE9(int a1, int a2)
{
  ...
  sub_10001F81(a1, (int)&ModuleName);
  sub_10001F5E(a2, (int)&ProcName);
...
FARPROC __cdecl sub_1000203E(int a1)
{
  return sub_10001FE9((int)&unk_10003288, a1);
}

//----- (1000204F) --------------------------------------------------------
FARPROC __cdecl sub_1000204F(int a1)
{
  return sub_10001FE9((int)&unk_100032A4, a1);
}
...
signed int __cdecl sub_10002060(int a1)
{
  ...
  sub_10002493(&v9, (const void *)v7, 0x80u);
...
int __cdecl sub_100024A7(const void *a1, int a2, void *a3)
{
  ...
  v4 = *(_WORD *)(a2 + 6);
  sub_10002493(a3, a1, *(_DWORD *)(a2 + 84));
  ...
  while ( 1 )
  {
    ...
    if ( v6 >= v4 )
      break;
    if ( *(_DWORD *)(v5 + 16) )
      sub_10002493((char *)a3 + *(_DWORD *)(v5 + 12), (char *)a1 + *(_DWORD *)(v5 + 20), *(_DWORD *)(v5 + 16));
    ++v6;
    v5 += 40;
  }
  return result;
...
signed int __cdecl sub_10002529(int a1, int a2)
{
  ...
  if ( *(_DWORD *)a2 )
  {
    ...
    else
    {
      ...
      {
        sub_10002493(v4, *(const void **)(a1 + 24), *(_DWORD *)(a1 + 28));
