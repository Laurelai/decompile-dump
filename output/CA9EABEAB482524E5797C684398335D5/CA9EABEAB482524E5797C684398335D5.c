...
proc3(int param3, int param4, int param2, int param1, int param5);
VOID proc4(PDRIVER_OBJECT DriverObject, PVOID Context, ULONG Count);
void proc5(int param3, int param2, int param4, int param1, int param5, int param6);
proc6();
void proc7(int param5, int param6, int param7, int param8, int param2, int param10, int param1, int param3, int param4);
proc8(int param4, int param7, int param5, int param6, int param1, int param2, int param3, int param8);
proc9(int param5, int param6, int param7, int param8, int param1, int param9, int param10, int param4, int param2, int param3);
...
proc18(int param7, int param5, int param6, int param2, int param1, int param3, int param4);
proc19(int param1);
...
proc28(int param4, int param5, int param1, int param3, int param2);
proc29(int param1);
...
NTSTATUS DriverEntry(PDRIVER_OBJECT DriverObject, PUNICODE_STRING RegistryPath) {
        ...
        while ((unsigned)*(int*)(local93 - 28) < 0x13e84) {
            ...
            if (local88 != local91) {
                *(int*)(local10 - 4) = local9;
                (**(int*)*(int*)(local93 - 28))(local6, local8, local5, local7, local9, 24, 512, local84, (unsigned char) local88, local86, local87, local88, local89, local90, local91, local93, local94, local95, 0, 0x13e80, <all>, global5[0], SUBFLAGS32(local88, local91, local88 - local91), (unsigned)local88 < (unsigned)local91);
                local64 = local49;
                local65 = global3;
                local66 = global1;
                local67 = global4;
    ...
    if (local88 == local91) {
        if (*(int*)0x13e98 != 0) {
            local87 = proc2(local84, local87, 0, 0x13e99, local91, 632, local95);
            global5 = local87;
        }
        local2 = local92;
        local83 = local2;
...
L8:
    ...
    *(int*)(local93 - 4) = *(int*)(local93 - 4) | -1;
    proc3(DriverObject, RegistryPath, local93, *(int*)(local93 - 16), *(int*)local93);
    return 0;
}
...
L3:
    ...
    return (unsigned char) param4; /* WARNING: Also returning: local34 */
}
...
proc3(int param3, int param4, int param2, int param1, int param5) {
    ...
    *(int*)0 = param1;
    return param3; /* WARNING: Also returning: param4, param5 */
}
...
VOID proc4(PDRIVER_OBJECT DriverObject, PVOID Context, ULONG Count) {
    ...
    *(int*)(local16 - 4) = *(int*)(local16 - 4) | -1;
    proc3(DriverObject, Context, local16, *(int*)(local16 - 16), *(int*)local16);
    return local11;
}
...
void proc5(int param3, int param2, int param4, int param1, int param5, int param6) {
    ...
    *(char*)(local3 - 5) = 0;
    local1 = proc8(local3 - 5, param3, (unsigned char) local3 - 5, param4, local3 - 4, param5, param6, <all>);
    if (local1 == 0) {
    }
    return;
}
